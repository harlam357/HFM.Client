namespace HFM.Client.Tool
{
   partial class AsyncMainForm
   {
      ...
      {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AsyncMainForm));
