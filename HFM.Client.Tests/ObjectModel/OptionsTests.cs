...
namespace HFM.Client.ObjectModel
{
    ...
    {
        [Test]
        public void Options_FromMessage_FromWindowsClientVersion_7_1_24()
        {
            var options = Options.FromMessage(TestDataReader.ReadString("Client_7_1_24_options_Windows.txt"));
